...
class TrojanMap {
 public:
  ...
  void Backtrack(std::vector<std::string> &location_ids, std::pair<double, std::vector<std::vector<std::string>>> &results, 
...
void reverse_2opt(std::vector<std::string> &location_ids,int i,int j);

double calculateCost(std::vector<std::string> &location_ids, int i, int j, int n);
  ...
  double CalculateAdjDistance(std::string &id1,std::string &id2,std::map<std::pair<std::string,std::string>,double> &adj_dis);

  void TSPBacktrack(std::vector<std::string> &current_path,std::set<std::string> &visited,std::vector<std::string> &location_ids,std::vector<std::string> &min_path, 
  double &min_dist,std::map<std::pair<std::string,std::string>,double> &adj_dis);
  ...
  bool isNodeExist(const std::string& node);


  bool canTravel(const std::string& start, const std::string& destination, double tankSize);
